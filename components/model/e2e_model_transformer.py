...
from components.model.modules.encoders.enc_transformer import Encoder
from components.model.modules.decoders.dec_transformer import Decoder
...
class E2ETransformer(E2ESeq2SeqModel):
    ...
    def set_decoder(self):
        ...
        self.decoder = Decoder(decoder_rnn_params)
